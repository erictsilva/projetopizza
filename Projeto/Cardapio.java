...
public class Cardapio {
    ...
    private void inicializarCardapio() {
        ...
        cardapio.put("Pizza Mista (Calabresa, Mussarela, Bacon e Presunto)", 35.00);
        cardapio.put("Quatro queijos", 37.00);
        cardapio.put("Calabresa", 33.00);
        cardapio.put("Frango c/ Catupiry", 36.50);
        cardapio.put("Portuguesa", 33.40);
        cardapio.put("Mussarela", 28.00);
        cardapio.put("Bacon", 38.70);
        cardapio.put("Vegetariana", 34.30);
        cardapio.put("Pizza Doce", 42.20);
    }
